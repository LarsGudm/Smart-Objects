...
if (!drawGuides) {
    ...
    // Circle parameters
    var radius = 5; // Adjust as needed
    var handleLength = radius * 0.55228475; // Bezier handle length for a circle
    ...
    // Define the inTangents and outTangents for smooth curves
    var inTangents = [
        [-handleLength, 0],
        [0, -handleLength],
        [handleLength, 0],
